  ...
  const services = [
    {
      ...
      label: t("service_physical_therapy"),
      desc: t("service_physical_therapy_desc"),
    ...
    },
    {
      ...
      label: t("service_psychiatry"),
      desc: t("service_psychiatry_desc"),
    ...
    },
    {
      ...
      label: t("service_pediatrics"),
      desc: t("service_pediatrics_desc"),
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-slate-800">
        <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-1">{t("health_services_title")}</h2>
        <p className="text-gray-500 dark:text-slate-400">{t("health_services_desc")}</p>
      </div>
        ...
        {services.map((service) => (
          ...
          >
            ...
            <div className="mt-4 flex items-center gap-2 text-sm font-bold text-red-600 dark:text-red-400">
              {t("request_service")} <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" />
            </div>
          </Link>
        ))}
      </div>
